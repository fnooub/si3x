...
class Paginator
{
	...
	*/
	...
	public function create_links()
	{
		...
		$html = '<ul class="pagination d-flex flex-wrap my-3">';
		if ($this->get_prev_url())
		{
			$html .= '<li class="page-item"><a class="page-link" href="' . htmlspecialchars($this->get_prev_url()) . '" data-page="' . $this->get_prev_page() . '">&laquo; ' . $this->_config['prev_link'] . '</a></li>';
		}
		...
		{
			$html .= '<li class="page-item"><a class="page-link" href="' . htmlspecialchars($this->get_next_url()) . '" data-page="' . $this->get_next_page() . '">' . $this->_config['next_link'] . ' &raquo;</a></li>';
		}
		$html .= '</ul>';
