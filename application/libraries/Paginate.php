...
class Paginate
{
	...
	*/
	...
	public function w3_create_links()
	{
		...
		if ($this->get_prev_url())
		{
			$html .= '<a class="w3-button w3-padding-small text-decoration-none w3-light-gray m-2 w3-text-blue" href="' . htmlspecialchars($this->get_prev_url()) . '" data-page="' . $this->get_prev_page() . '">&laquo; ' . $this->_config['prev_link'] . '</a>';
		}
		...
		if ($this->get_next_url())
		{
			$html .= '<a class="w3-button w3-padding-small text-decoration-none w3-light-gray m-2 w3-text-blue" href="' . htmlspecialchars($this->get_next_url()) . '" data-page="' . $this->get_next_page() . '">' . $this->_config['next_link'] . ' &raquo;</a>';
		}
		$html .= '</div>';
